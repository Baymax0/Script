...
SCHEME_NAME="wangfuAgent"
# # 项目路径   ‘网付.xcodeproj’所在的目录
SOURCE_PATH="/Users/YiMi/Desktop/网付合伙人/wangfuAgent"
# # 打包环境，1＝ad-hoc
PACKAGE_TYPE=1
...
# # fir.im上的短连接
FIR_PROCECT_SHORT_LINK="wangfuagent"
...
ConfigurationBuildDir="${BASE_PATH}/AdHocExportOptions.plist"
